          ...
          <div className="home-osaka-cover overflow-hidden rounded-lg border border-sora/18 bg-paper p-3 shadow-card sm:p-4">
            <div className="home-osaka-cover-inner relative aspect-[9/13] min-h-[26rem] overflow-hidden rounded-md sm:aspect-[4/5] lg:h-full lg:min-h-[34rem]">
              <img
                src={homeStudyScene}
                alt="大阪道顿堀河岸街景封面"
                className="home-osaka-cover-image h-full w-full object-cover object-[center_44%]"
                loading="eager"
              />
              <div className="home-osaka-cover-shade absolute inset-0 bg-gradient-to-t from-ink/42 via-ink/0 to-paper/10" />
              <div className="home-osaka-cover-location absolute left-3 top-3 rounded-md border border-paper/70 bg-paper/86 px-3 py-2 shadow-card backdrop-blur">
              ...
              <div className="home-osaka-cover-panel absolute inset-x-3 bottom-3 rounded-md border border-paper/70 bg-paper/92 p-3 shadow-card backdrop-blur">
